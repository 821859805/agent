...
def get_container(ctr_name: str, image_name: str, **kwargs):
    """
    ...
    if ctr_name in all_containers:
        ...
        kwargs["ports"] = kwargs["ports"] or {}
        container = client.containers.run(image=image, name=ctr_name, detach=True, tty=True, ports=kwargs["ports"])
